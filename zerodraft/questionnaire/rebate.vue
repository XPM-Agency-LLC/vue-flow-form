        ...
        <div class="f-section-wrap">
          <p>
            ...
            <span class="f-section-text">
              Great work, your questionnaire is completed, and our demo is done.
              You can review your number and email or press submit.
              <br />
              <br />
              Full Name: {{ questions[0].answer }}
              <br />
              E-Mail: {{ questions[1].answer }}
              <br />
              Number: {{ questions[2].answer }}
            </span>
          </p>
...
import TestQuestioins, { FastFood, StripClub } from "../../src/models/TestQuestions";
  ...
  data() {
    return {
      ...
      questions: [
        ...
        new QuestionModel({
          id: "multiple_choices_business",
          title: FastFood.FastFoodq1,
          type: QuestionType.MultipleChoice,
          multiple: false,
          helpText: "Select the best one that applies. 👇",
          required: true,
          options: [
            new ChoiceOption({
              label: FastFood.Type,
        ...
        new QuestionModel({
          id: "path_d",
          title: FastFood.FastFoodq2,
          content: "Do you serve wings at your fast food business?",
          type: QuestionType.MultipleChoice,
          multiple: false,
          required: true,
          options: [
        ...
        new QuestionModel({
          id: "fastfoodq2",
          title: "PATH D: Do you serve fries at your fast food business?",
          content: "Do you serve fries at your fast food business?",
          type: QuestionType.MultipleChoice,
          multiple: false,
          required: true,
          options: [
        ...
        new QuestionModel({
          id: "fastfoodq3",
          title: "PATH D: Do you serve strippers at your fast food business?",
          content: "Do you serve strippers at your fast food business?",
          type: QuestionType.MultipleChoice,
          multiple: false,
          required: true,
          options: [
